...
{
	u16	Read;		/* @field Current Read index. */
	u16	Write;		/* @field Current Write index. */
	u16	Length;		/* @field Length of buffer */
	u8	*CharBuffer;		/* @field Start of buffer */
}BUFFER_INFO;
...
/* void Get32FromBuff(BUFFER_INFO *Buf,u32 DATA) */
...
/*void Put32toBuff(BUFFER_INFO *Buf,u32 *DATA)*/
